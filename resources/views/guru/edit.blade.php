...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <h2 class="text-lg font-bold text-gray-800 dark:text-white mb-6">Edit Akun Guru</h2>
        ...
        <form action="{{ route('guru.update', $guru) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <select name="kelas" class="input-field @error('kelas') border-red-500 @enderror">
                    ...
                    <option value="{{ $kelas }}" {{ old('kelas', $guru->kelas) === $kelas ? 'selected' : '' }}>
                        Kelas {{ $kelas }}
                    </option>
                    @endforeach
                </select>
            ...
            <div>
                <label class="label-field">Password Baru <span class="text-gray-400 text-xs">(kosongkan jika tidak diubah)</span></label>
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit" class="btn-primary flex-1">Update Akun</button>
