...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <h2 class="text-lg font-bold text-gray-800 dark:text-white mb-6">Edit Data Siswa</h2>
        ...
        <form action="{{ route('students.update', $student) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <select name="kelas" class="input-field @error('kelas') border-red-500 @enderror">
                    ...
                    <option value="{{ $kelas }}" {{ old('kelas', $student->kelas) === $kelas ? 'selected' : '' }}>
                        Kelas {{ $kelas }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit" class="btn-primary flex-1">Update Data</button>
